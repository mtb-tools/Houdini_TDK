...
class OperatorManagerNodeTypeModel(QAbstractItemModel):
    ...
    def updateData(self):
        ...
        for category_name, category in list(hou.nodeTypeCategories().items()):
            category_types = types[category_name] = {}
            for node_type in list(category.nodeTypes().values()):
        ...
        for category_name in self._category_names:
            ...
            types[category_name] = {
                ...
                for type_name, node_types in list(types[category_name].items())
            }
    ...
    def hasChildren(self, parent):
        ...
        elif isinstance(parent.internalPointer(), (str, TypeNameItem)):
            return True
        else:
            return False
    ...
    def rowCount(self, parent):
        ...
        elif isinstance(parent.internalPointer(), str):
